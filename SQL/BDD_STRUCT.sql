...
-- Listage des données de la table cinema-lecam.be : ~6 rows (environ)
INSERT INTO `be` (`id_movie`, `id_type`) VALUES
	(1, 1),
	(2, 2),
	(3, 3),
	(4, 4),
...
-- Listage des données de la table cinema-lecam.casting : ~13 rows (environ)
...
INSERT INTO `movie` (`id_movie`, `name`, `date_release`, `duration`, `synopsis`, `poster`, `rate`, `id_director`) VALUES
	(1, 'Epic Adventure', '2023-06-01', 120, 'An epic adventure of discovery and courage.', 'https://folkr.fr/wp-content/uploads/2015/12/top-20-affiches-films-2015-folkr-Realite.jpg', 8.5, 1),
	(2, 'Romantic Escape', '2023-02-14', 95, 'A love story that transcends time.', 'https://www.mauvais-genres.com/img/p/7/4/2/2/7422.jpg', 7.8, 2),
	(3, 'Mystery Thriller', '2023-09-10', 150, 'A thrilling mystery that keeps you on the edge of your seat.', 'https://fr.web.img4.acsta.net/pictures/210/240/21024019_20130801183449394.jpg', 8.2, 3),
	(4, 'Sci-Fi Odyssey', '2023-12-20', 200, 'A journey through space and time.', 'https://media.senscritique.com/media/000012288077/source_big/Pulp_Fiction.jpg', 9.0, 4),
	(5, 'Comedy Night', '2023-07-18', 85, 'A night full of laughs and surprises.', 'https://th.bing.com/th/id/R.dd8b2981c9452b9ece9eafa660b42df4?rik=6nS4P%2b9KRKD1JQ&pid=ImgRaw&r=0', 7.5, 3),
	(6, 'Historical Drama', '2023-11-05', 180, 'A poignant drama set in historical times.', 'https://fr.web.img3.acsta.net/pictures/14/09/12/17/19/272469.jpg', 8.8, 4);
...
INSERT INTO `person` (`id_person`, `name`, `firstname`, `birthday`, `genre`) VALUES
